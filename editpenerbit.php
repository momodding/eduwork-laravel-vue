...
<body>
  ...
  <form action="editpenerbit.php?penerbit=<?php echo $id_penerbit; ?>" method="post">
  ...
  <?php
    ...
    if(isset($_POST['update'])) {
      ...
      $result = mysqli_query($mysqli, "UPDATE penerbit SET nama_penerbit = '$nama_penerbit', email = '$email', telpt = '$telp', alamat = '$alamat' WHERE id_penerbit = '$id_penerbit';");
