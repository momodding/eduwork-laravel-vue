<?php
    ...
    $penerbit = mysqli_query($mysqli, "SELECT penerbit.*, nama_penerbit, email, telp FROM penerbit");
?>
...
<a href="add_penerbit.php">Add Penerbit</a><br/><br/>
    ...
    <?php  
        while($penerbit_data = mysqli_fetch_array($penerbit)) {         
            echo "<tr>";
            echo "<td>".$penerbit_data['id_penerbit'];
