<?php
    ...
    $pengarang = mysqli_query($mysqli, "SELECT pengarang.*, nama_pengarang, email, telp FROM pengarang");
?>
...
<a href="add_pengarang.php">Add Pengarang</a><br/><br/>
    ...
    <?php  
        while($pengarang_data = mysqli_fetch_array($pengarang)) {         
            echo "<tr>";
            echo "<td>".$pengarang_data['id_pengarang'];
