                    ...
                    <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="date_start" :value="data.date_start"
                                    required="">
                            </div>
                            <div class="form-group">
                                <label>Date End</label>
                                <input type="text" class="form-control" name="date_end" :value="data.date_end"
                                    required="">
                            </div>
                            <div class="form-group">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        var actionUrl = '<?php echo e(url('transactions')); ?>';
        var apiUrl = '<?php echo e(url('api/transactions')); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\library\resources\views/admin/transaction.blade.php ENDPATH**/ ?>