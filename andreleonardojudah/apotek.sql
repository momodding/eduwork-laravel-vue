...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3774357290ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=obat">`apotek`.`obat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=pasien">`apotek`.`pasien`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apotek&table=transaksi">`apotek`.`transaksi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=buku">`perpustakaan`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=penulis">`perpustakaan`.`penulis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=salon+auto+detailing+mobil&table=obat_poles">`salon auto detailing mobil`.`obat_poles`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="56432271624b632e2558404e74407828">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="apotek" targettable="pasien">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pasien`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="obat">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `obat`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="pasien">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE obat
ADD CONSTRAINT fk_pasien
FOREIGN KEY (id_obat) REFERENCES pasien(id_obat);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="pasien">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `pasien` (`id_obat`, `nama_pasien`, `tanggal_lahir`, `alamat`, `no_tlp`) VALUES (NULL, &#039;Andre Leonardo&#039;, &#039;2022-05-16&#039;, &#039;Jakarta Timur&#039;, &#039;081280492727&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="apotek" targettable="pasien">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `pasien` (`id_obat`, `nama_pasien`, `tanggal_lahir`, `alamat`, `no_tlp`) VALUES (NULL, &#039;Judah&#039;, &#039;2022-05-25&#039;, &#039;Jakarta Pusat&#039;, &#039;081280492121&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="pasien">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `obat` (`id_obat`, `nama_obat`, `pembuat_obat`, `stok_obat`, `tanggal_kadaluwarsa`) VALUES (&#039;1&#039;, &#039;Vicks Formula 44 Sirup&#039;, &#039;Darya Varia Laboratoria&#039;, &#039;35&#039;, &#039;2024-05-30&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="obat">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `apotek`.`pasien` WHERE `id_obat` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="apotek" targettable="pasien">
                            <div class="action_content">
