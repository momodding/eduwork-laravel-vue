                ...
                <div class="modal-content">
                    <form :action="actionUrl" method="post" autocomplete="off" @submit="submitForm($event, book.id)">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Tahun</label>
                                <input type="number" name="year" class="form-control" required="" placeholder="YYYY" min="2000" max="2023":value="book.year">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="qty" class="form-control" required="" :value="book.qty">
                            </div>
                            <div class="form-group">
