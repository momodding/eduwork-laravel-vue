...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Bikeshop</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            <li class="nav-item">
                <a href="{{ url('cateories') }}" class="nav-link {{ request()->is('categories') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('variants') }}" class="nav-link {{ request()->is('variants') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-edit"></i>
                    <p>
                        Variant
                    </p>
