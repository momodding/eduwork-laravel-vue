...
Route::get('/dashboards', [App\Http\Controllers\AdminController::class, 'dashboard'])->name('dashboard');
...
//  Route::resource('/dashboards', App\Http\Controllers\AdminController::class);
...
Route::get('/api/dashboards', [App\Http\Controllers\AdminController::class, 'api']);
