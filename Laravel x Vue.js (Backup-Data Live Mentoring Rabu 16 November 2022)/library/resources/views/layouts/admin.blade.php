      ...
      <li class="nav-item dropdown show">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right show" style="left: inherit; right: 0px;">
            ...
            <a href="#" class="dropdown-item">
              <i class="fas fa-file mr-2"></i> Allen O Conner melewati batas 3 hari
            </a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-file mr-2"></i> Isadore Barton melewati batas 10 hari
            </a>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-file mr-2"></i> Edwardo Yost melewati batas 15 hari
            </a>
            <div class="dropdown-divider"></div>
