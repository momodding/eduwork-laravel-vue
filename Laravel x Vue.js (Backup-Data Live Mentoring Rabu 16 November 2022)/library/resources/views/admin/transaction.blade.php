        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-striped table-bordered" width="1600px">
                            <thead>
                                <tr>
    ...
    $(function() {
        $('input[name=daterange]').daterangepicker({
            opens: 'left'
                    ...
                    var apiurlfilter = apiUrl + '?startdate='+startdate +'&enddate=' +enddate
                    controller.table.ajax.url(apiurlfilter).load();
