...
<body>
	...
	<form action="edit-penerbit.php?id_penerbit=<?php echo $id_penerbit; ?>" method="post">
		<table width="25%" border="0">
			...
			<tr> 
				<td></td>
				<td><input type="submit" name="update-penerbit" value="Update"></td>
			</tr>
		</table>
	</form>
	...
	<?php
		...
		if(isset($_POST['update-penerbit'])) {
